...
local item = {
  ...
  icon = "__alternative-beacons-ex__/graphics/icon-focused.png",
  icon_size = 64,
  stack_size = 20,
  subgroup = "module",
  order = "a[beacon]b"
  ...
  animation_list = {
    {
      ...
      animation = {
        layers = {
          {
            filename = "__alternative-beacons-ex__/graphics/hr-focused-base.png",
            width = 232,
            height = 186,
...
local technology = {{
  icon = "__alternative-beacons-ex__/graphics/tech-focused.png",
  icon_size = 256
}}
